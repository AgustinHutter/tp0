...
{
	t_log* nuevo_logger = log_create("cliente.log","Agustin",1,LOG_LEVEL_INFO);
...
{
	t_config* nuevo_config=config_create("/home/utnso/Desktop/Proyecto/tp0/client/cliente.config");
